...
def main():
    ...
    parser.add_argument('--config', type=str, default='configs/celeba2.yaml', help='path to the config file.')
    parser.add_argument('--output_path', type=str, default='tensorDump', help='output path of the tensorboard file')
