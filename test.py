...
def main():
    ...
    parser.add_argument('--config', type=str, default='./configs/celeba2.yaml', help="net configuration")
    parser.add_argument('--output_folder', type=str, default='./outputs/celebahq_custom', help="output image path")
    parser.add_argument('--checkpoint', type=str, default='./tensorDump/outputs/celeba2/checkpoints/80000_G.pth',
    ...
    with torch.no_grad():
        ...
        for index, test_data in tqdm(enumerate(test_loader)):
